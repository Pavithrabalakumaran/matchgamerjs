...
class App extends Component {
  ...
  render() {
    const {score, timer, imgUrl, isTrue, category} = this.state
          ...
          <ul className="score-section">
            ...
            <li className="score-section">
              <img
                ...
                alt="timer"
              />
              <p className="timer-des">{timer} sec</p>
            </li>
          </ul>
        </nav>
        <div className="second-container">
          {!isTrue && (
            <div className="first-image-tab">
              <img src={imgUrl} className="full-size-image" alt="match" />
